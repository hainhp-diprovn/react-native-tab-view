  ...
  React.useEffect(() => {
    ...
    if (indexRef.current !== index) {
      if (disableAnimationForSetPage === true) {
        ...
        (_pagerRef$current3 = pagerRef.current) === null || _pagerRef$current3 === void 0 ? void 0 : _pagerRef$current3.setPageWithoutAnimation(index);
      } else {
        var _pagerRef$current4;

        (_pagerRef$current4 = pagerRef.current) === null || _pagerRef$current4 === void 0 ? void 0 : _pagerRef$current4.setPage(index);
      }
    }
